...
const { components, utilities } = require("nuxt-dynamic-markdown");
const DynamicMarkdown = require("nuxt-dynamic-markdown/dist/DynamicMarkdown.js");
const { loadDynamicMarkdown } = utilities;
